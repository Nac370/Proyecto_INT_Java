...
<h1 class="text-2xl font-bold mb-6 text-center">Eliminar Cuentas</h1>

<form action="ServletEliminarCuentas" method="post" class="mb-4">
    ...
    %>
        ...
        <tbody>
            <tr>
                ...
                <td class="p-2 border"><%= cu.getTipoCuenta() %></td>
                <td class="p-2 border"><%= cu.getCbuCuenta() %></td>
                <td class="p-2 border"><%= cu.getSaldoCuenta() %></td>
                <td class="p-2 border">
                    <form action="ServletEliminarCuentas" method="post">
                        <input type="hidden" name="CuentaEliminar" value="<%= cu.getNumeroCuenta() %>">
                        <input type="submit" name="btnEliminar" value="Eliminar" class="bg-red-500 text-white px-4 py-2 rounded cursor-pointer hover:bg-red-600" onclick="return confirm('¿Estás seguro de que deseas eliminar la cuenta?');">
                    </form>
                </td>
            </tr>
                 <%
